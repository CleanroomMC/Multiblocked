...
public class RecipePage extends PageWidget{
    ...
    private void readRecipe(PacketBuffer buffer) {
        if (buffer.readBoolean()) {
            ...
            this.addWidget(recipeWidget = new RecipeWidget(recipe, ()->controller.recipeLogic.progress * 1.0 / controller.recipeLogic.duration, controller.getDefinition().recipeMap.progressTexture));
