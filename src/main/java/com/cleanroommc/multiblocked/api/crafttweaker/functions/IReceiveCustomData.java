...
@FunctionalInterface
@ZenClass("mods.multiblocked.functions.IReceiveCustomData")
@ZenRegister
public interface IReceiveCustomData {
    @Optional.Method(modid = Multiblocked.MODID_CT)
    void apply(ICTComponent componentTileEntity, int id, IData data);
}
