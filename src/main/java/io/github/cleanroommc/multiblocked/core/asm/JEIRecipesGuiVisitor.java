...
import io.github.cleanroommc.multiblocked.core.asm.util.ObfMapping;
...
public class JEIRecipesGuiVisitor extends MethodVisitor implements Opcodes {
    ...
    public static final ObfMapping TARGET_METHOD = new ObfMapping(
            ...
            "func_146274_d",
            "()V");
    private static final ObfMapping METHOD_HOOKS = new ObfMapping(
            "io/github/cleanroommc/multiblocked/core/asm/hooks/JEIHooks",
            "handleMouseInput",
