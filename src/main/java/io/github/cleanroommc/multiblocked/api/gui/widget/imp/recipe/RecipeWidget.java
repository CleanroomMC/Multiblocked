...
public class RecipeWidget extends WidgetGroup {
    ...
    public RecipeWidget(Recipe recipe) {
        ...
        this.recipe = recipe;
        setClientSideWidget();
        DraggableScrollableWidgetGroup inputs = new DraggableScrollableWidgetGroup(5, 30, 64, 64).setBackground(new ColorRectTexture(-1));
        DraggableScrollableWidgetGroup outputs = new DraggableScrollableWidgetGroup(85, 30, 64, 64).setBackground(new ColorRectTexture(-1));
