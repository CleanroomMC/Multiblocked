...
public class TreeListWidget<K, T> extends Widget {
    ...
    public void drawInBackground(int mouseX, int mouseY, float partialTicks) {
        ...
        if (background != null) {
            ...
            DrawerHelper.drawGradientRect(x, y, width, height, 0x8f000000, 0x8f000000);
        }
            ...
            for (int i = minToRender; i < maxToRender; i++) {
                ...
                if (node.isLeaf()) {
                    if (leafTexture != null) {
                        ...
                        DrawerHelper.drawSolidRect(x, sY, width, ITEM_HEIGHT, 0xffff0000);
                    }
                    ...
                    if (nodeTexture != null) {
                        ...
                        DrawerHelper.drawSolidRect(x, sY, width, ITEM_HEIGHT, 0xffffff00);
                    }
                ...
                if (node == selected) {
                    DrawerHelper.drawSolidRect(x, sY, width, ITEM_HEIGHT, 0x7f000000);
                }
